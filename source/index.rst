...
2. :doc:`Програмування мовою Сі для ОС Linux. GCC, CLANG. Розробка та налагодження програм. Створення статичних і динамічних бібліотек. Linux kernel coding style. QEMU. <labs/lab06>`
